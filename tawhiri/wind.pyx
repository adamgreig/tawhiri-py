...
cdef class Dataset:
    ...
    cdef double _read_var(self, int time_idx, int pressure_idx, int var_idx,
    ...
    cpdef public WindSpeed get_wind(self, double time, double  alt, double lat,
        ...
        ret.u = u_l * p_lerp_m + u_r * p_lerp
        ret.v = v_l * p_lerp_m + v_r * p_lerp
